package com.ccyx.maker.template;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.json.JSONUtil;
import com.ccyx.maker.template.TemplateMaker;
import com.ccyx.maker.meta.Meta;
import com.ccyx.maker.template.model.TemplateMakerConfig;
import com.ccyx.maker.template.model.TemplateMakerFileConfig;
import com.ccyx.maker.template.model.TemplateMakerModelConfig;
...
public class TemplateMakerTest {
    ...
    public void testMakeTemplateBug1() {
        ...
        String originProjectPath = new File(projectPath).getParent() + File.separator + "ccyxGenerator-demo-projects/springboot-init";
    ...
    public void testMakeTemplateBug2() {
        ...
        // 文件参数配置，扫描目录
        String inputFilePath1 = "src/main/java/com/ccyx/springbootinit/common";
        TemplateMakerFileConfig templateMakerFileConfig = new TemplateMakerFileConfig();
        TemplateMakerFileConfig.FileInfoConfig fileInfoConfig1 = new TemplateMakerFileConfig.FileInfoConfig();
        fileInfoConfig1.setPath(inputFilePath1);
        templateMakerFileConfig.setFiles(Arrays.asList(fileInfoConfig1));
...
//        modelInfoConfig1.setReplaceText("BaseResponse");
        ...
        modelInfoConfig1.setType("String");
        modelInfoConfig1.setReplaceText("com.ccyx");
        List<TemplateMakerModelConfig.ModelInfoConfig> modelInfoConfigList = Arrays.asList(modelInfoConfig1);
        templateMakerModelConfig.setModels(modelInfoConfigList);
