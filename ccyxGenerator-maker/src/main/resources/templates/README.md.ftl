...
```
generator generate <#list modelConfig.models as modelInfo><#-- 有分组 --><#if modelInfo.groupKey??><#list modelInfo.models as subModelInfo>-${subModelInfo.abbr!"noAbbr"} </#list><#else>-${modelInfo.abbr!"noAbbr"} </#if></#list>
```
